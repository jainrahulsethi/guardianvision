...
if not df.empty:
    ...
    for index, row in df.iterrows():
        ...
        # Prepare initial payload
            ...
            url_image_upload = f"{url}/{_id}/{_activity_instance_id}/Alert_Snapshot/image"
            files = [
            ...
            url_submit = f"{url}/{_id}/{_activity_instance_id}/submit"
            headers_submit = {
                'X-Access-Key-Id': access_id,
                'X-Access-Key-Secret': secret_id,
                'Content-Type': 'application/json'
...
# MAGIC %sql
# MAGIC MERGE INTO genai_applications.guardianvision.safety_assessment_log AS t
