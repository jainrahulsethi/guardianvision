...
vectorsearch_config = docx_data_pipeline_config['vectorsearch_config']
embedding_config = docx_data_pipeline_config['embedding_config']
pipeline_config = docx_data_pipeline_config['pipeline_config']

print(f"Using POC data pipeline config: {json.dumps(docx_data_pipeline_config, indent=4)}\n")
...
Context: {context}""".strip(),
    ...
    "input_example": {
        "messages": [
            {
                "role": "user",
                "content": "What is the chart of accounts for Depreciation of Buildings",
            },
        ]
    },
}
